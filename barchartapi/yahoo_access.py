...
def load_yahoo_quote(ticker, beg_date, end_date, info = 'quote', format_output = 'dataframe',interval='1d'):
    '''
    This function load the corresponding history/divident/split from Yahoo.
    '''
    ### make sure dates are strings
    begindate = str(beg_date)
...
if __name__=='__main__':
    ...
    begindate = 20160901
    enddate = 20190131
    df = load_yahoo_quote(ticker, begindate, enddate,interval='1d')
    print(df)
